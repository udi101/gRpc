...
function deserialize_Greet_GreetRequest(buffer_arg) {
  return greet_proto_greet_pb.GreetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_Greet_GreetResponse(buffer_arg) {
  return greet_proto_greet_pb.GreetResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
